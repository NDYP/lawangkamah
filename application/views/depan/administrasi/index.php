            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <a target="_blank" href="<?= base_url('cetak/biodata'); ?>" class="btn btn-social btn-flat bg-green-gradient btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-print"></i> Biodata</a>
                        <a target="_blank" href="<?= base_url('cetak/keluarga'); ?>" class="btn btn-social btn-flat bg-green-gradient btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-print"></i> Keluarga</a>
                        <a target="_blank" href="<?= base_url('administrasi/ktpsementara'); ?>" class="btn btn-social btn-flat bg-green-gradient btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-plus-circle"></i> KTP Sementara</a>
                        <a href="<?= base_url('administrasi/spt'); ?>" class="btn btn-social btn-flat bg-green-gradient btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-plus-circle"></i> Surat Penerbitan Tanah</a>
                        <a href="<?= base_url('administrasi/domisili'); ?>" class="btn btn-social btn-flat bg-green-gradient btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-plus-circle"></i> Domisili</a>
                        <a data-toggle="modal" data-target="#modal-tambah-keramaian" class="btn btn-social btn-flat bg-green-gradient btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-plus-circle"></i> Izin Kermaian</a>
                        <a data-toggle="modal" data-target="#modal-tambah-npwp" class="btn btn-social btn-flat bg-green-gradient btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-plus-circle"></i> NPWP</a>
                        <a data-toggle="modal" data-target="#modal-tambah-penghasilan" class="btn btn-social btn-flat bg-green-gradient btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-plus-circle"></i> Penghasilan/untuk Siswa </a>
                        <a data-toggle="modal" data-target="#modal-tambah-usaha" class="btn btn-social btn-flat bg-green-gradient btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-plus-circle"></i> Usaha</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php else : ?>
                                                            <?php if ($x['opsi'] == 'KTP Sementara') : ?>
                                                                <a class="btn btn-xs btn-info" href="<?= base_url('cetak/ktpsementara') ?>">
                                                                    Cetak
                                                                </a>
                                                            <?php elseif ($x['opsi'] == 'Izin Keramaian') : ?>
                                                                <a class="btn btn-xs btn-info" href="<?= base_url('cetak/keramaian') ?>">
                                                                    Cetak
                                                                </a>
                                                            ...
                                                            <?php elseif ($x['opsi'] == 'Penghasilan') : ?>
                                                                <a class="btn btn-xs btn-info" href="<?= base_url('cetak/penghasilan') ?>">
                                                                    Cetak
                                                                </a>
                                                            <?php elseif ($x['opsi'] == 'Izin Usaha') : ?>
                                                                <a class="btn btn-xs btn-info" href="<?= base_url('cetak/usaha') ?>">
                                                                    Cetak
                                                                </a>
                                                            <?php elseif ($x['opsi'] == 'Keterangan Domisili') : ?>
                                                                <a class="btn btn-xs btn-info" href="<?= base_url('cetak/domisili') ?>">
                                                                    Cetak
                                                                </a>
                                                            ...
                                                            <?php if ($x['status'] == 'Diterima' || $x['status'] == 'Ditolak') : ?>
                                                                <a class="btn btn-xs btn-warning" href="<?= base_url('cetak/hapus/' . $x['id_pengajuan']) ?>">
                                                                    Hapus
                                                                </a>
                                                            <?php endif; ?>
                                                        <?php endif; ?>
