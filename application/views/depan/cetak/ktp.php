...
<body>
    ...
    <p align="">
        <font face="Times New Roman" font size="">
            Adalah benar nama yang bersangkutan diatas adalah Penduduk <?= $akun['alamat_sekarang']; ?>, Desa Lawang Kamah, Kecamatan Timpah, Kabupaten Kapuas dan e-KTP yang bersangkutan masih dalam proses di Dinas DUKCAPIL Kab. Kapuas.
    </p>
    <br>
    <p align="">
        <font face="Times New Roman" font size="">
            Demikian surat Keterangan KTP Sementara ini diberikan untuk dapat dipergunakan sebagai mana mestinya.
    </p>
    <br>
    <br>
    <br>
