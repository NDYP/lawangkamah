    ...
    <section class="content">
        <div class="row">
            <form enctype="multipart/form-data" role="form"
                action="<?= base_url('admin/Dropdown_pendidikan/tambah'); ?>" method="post" class="form-horizontal">
                <!-- /.col (left) -->
                <div class="col-md-12">
                    <div class="box ">
                        <div class="box-header with-border">
                            <a href="<?= base_url('admin/Dropdown_pendidikan/index'); ?>"
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-3 control-label-left">Nama pendidikan</label>
                                <div class="col-sm-3">
                                    <input type="text" name="pendidikan" id="" class="form-control input-sm">
