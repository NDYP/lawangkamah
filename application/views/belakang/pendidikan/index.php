...
<div class="content-wrapper" style="min-height: 926px;">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?= base_url('admin/Dropdown_pendidikan/index'); ?>"><?= $title; ?></a></li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <a href="<?= base_url('admin/Dropdown_pendidikan/tambah'); ?>"
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li>
                                                                <a data-id_pendidikan="<?= $x['id_pendidikan']; ?>"
                                                                    data-toggle="modal"
                                                                    data-target="#modal-edit<?= $x['id_pendidikan']; ?>"
                                                                    class="btn btn-social btn-flat btn-block btn-sm"><i
                                                                        class="fa fa-upload"></i> Edit Bantuan</a>
                                                            </li>
                                                            <li>
                                                                <a href="<?= base_url('admin/Dropdown_pendidikan/hapus/' . $x['id_pendidikan']); ?>"
                                                                    class="btn btn-social btn-flat btn-block btn-sm"><i
        ...
        <!-- /.row -->
        <?php $no = 0;
        foreach ($pendidikan as $z) :
            $no++; ?>
        <div class="modal fade" id="modal-edit<?= $z['id_pendidikan']; ?>">
            <div class="modal-dialog">
                <form name="myform" onsubmit="return val()" enctype="multipart/form-data" role="form"
                    action="<?= base_url('admin/Dropdown_pendidikan/ubah'); ?>" method="post">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <input type="hidden" value="<?= $z['id_pendidikan']; ?>" name="id_pendidikan" id=""
                                    class="form-control input-sm">
                                <div class="col-xs-12">
                                    <label class="">Nama Pendidikan</label>
                                    <input type="text" value="<?= $z['pendidikan']; ?>" name="pendidikan" id=""
                                        class="form-control input-sm">
                                </div>
                                <br>
                            </div>
