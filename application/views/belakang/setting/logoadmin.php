...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <form enctype="multipart/form-data" role="form" action="<?= base_url('admin/setting/ubahlogoadmin'); ?>" method="post" class="form-horizontal">
                <!-- /.col (left) -->
                <div class="col-md-12">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-xs-4">
                                    ...
                                    <center>
                                        <img class="img-identitas img-responsive" src="<?= base_url('assets/foto/setting/' . $setting['logo_admin']) ?>" alt="logo" style="width: 50%">
                                    </center>
                                    <p class="text-red text-center">*Kosongkan jika tidak ingin diubah*</p>
                                    <input name="logo_admin" type="file" class="form-control input-sm">
