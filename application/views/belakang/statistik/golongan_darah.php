        ...
        <ul class="nav nav-tabs">
            <div class="box-header with-border">
                <a class="btn btn-social btn-flat bg-orange btn-sm" title="Grafik Data" href="#tab_1" data-toggle="tab">
                    <i class="fa fa-bar-chart"></i>Tabel Data
                </a>
                ...
                <a class="btn btn-social btn-flat bg-purple btn-sm" title="Pie Data" href="#tab_3" data-toggle="tab">
                    <i class="fa fa-pie-chart"></i>Line Data
                </a>
                <a class="btn btn-social btn-flat bg-red btn-sm" title="Line Data"
                    href="<?= base_url('admin/excel/golongan_darah') ?>">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-left"><a
                                        href="<?= base_url('admin/statistik/daftar_darah/' . $x['id_golongan_darah']) ?>"><?= $x['golongan_darah']; ?></a>
                                </td>
                                <td class="text-right">
