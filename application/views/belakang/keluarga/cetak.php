...
<body>
    <center>
        <div class="row">
            <div class="col-md-12">
                <img src="<?= base_url('assets'); ?>/foto/desa/x.jpeg" alt="" style="padding:0%;position: absolute; width: 60px; height: auto;">
            </div>
            <div class="col-md-12">
    ...
    <table class="table-responsive" style="width: 100%; page-break-after: never;" border="1" cellspacing="">
        ...
        <tr>
            ...
            <th>Pendidikan</th>
            <th>Pekerjaan</th>
            <th>Status <br> Dalam <br> Keluarga</th>
        </tr>
        <?php $no = 0;
        foreach ($keluarga as $x) : $no++; ?>
            <tr>
                ...
                <td><?= $x['tempat_lahir'] ?>, <?= date('d-m-Y', strtotime($x['tanggal_lahir'])); ?></td>
                <td><?= $x['pendidikan'] ?></td>
                <td><?= $x['pekerjaan'] ?></td>
                <td><?= $x['status_kk'] ?></td>
            </tr>
    ...
    <table class="table-responsive" style="width: 100%; page-break-after: never;" border="" cellspacing="0">
        ...
        <tr>
            <td></td>
            <td width="500">
                <font face="Times New Roman" font size="12px">Kepala Keluarga<br> <br> <br><br>
                    <p><?= $kk['nama_lengkap'] ?></p>
            </td>
            <td></td>
