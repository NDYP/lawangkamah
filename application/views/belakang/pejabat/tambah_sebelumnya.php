...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <form enctype="multipart/form-data" role="form" action="<?= base_url('admin/pejabat_desa/tambah_pejabat_sebelumnya'); ?>" method="post" class="form-horizontal">
                <div class="col-md-12">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-xs-4">
                                    ...
                                    <input name="no_sk_pemberhentian" type="text" class="form-control input-sm" value="<?= set_value('no_sk_pemberhentian'); ?>">
                                    <?= form_error('no_sk_pemberhentian', '<small class="text-danger pl-1">', '</small>'); ?>
                                </div>
                                <div class="col-xs-4">
                                    <label for="">Tanggal SK Pemberhentian</label>
                                    <input id="datepicker2" name="tgl_sk_pemberhentian" type="text" class="form-control input-sm" value="<?= set_value('tgl_sk_pemberhentian'); ?>">
                                    <?= form_error('tgl_sk_pemberhentian', '<small class="text-danger pl-1">', '</small>'); ?>
                                </div>
                                <div class="col-xs-4">
                                    <label for="">Masa Jabatan</label>
                                    <input name="masa_jabatan" type="text" class="form-control input-sm" value="<?= set_value('masa_jabatan'); ?>">
                                    <?= form_error('masa_jabatan', '<small class="text-danger pl-1">', '</small>'); ?>
                                </div>
                            </div>
                            <br>
                        </div>
