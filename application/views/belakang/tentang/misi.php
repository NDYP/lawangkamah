...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <form enctype="multipart/form-data" role="form" action="<?= base_url('admin/tentang/misi'); ?>" method="post" class="form-horizontal">
                <!-- /.col (left) -->
                <div class="col-md-12">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="box-body pad">
                                    <form>
                                        <textarea class="textarea" placeholder="" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" value="<?= $tentang['misi']; ?>" name="misi">
                                        <?= $tentang['misi']; ?>
                                        </textarea>
                                    </form>
                                </div>
