...
<div class="content-wrapper" style="min-height: 926px;">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?= base_url('admin/Dropdown_status/index'); ?>"><?= $title; ?></a></li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <a href="<?= base_url('admin/Dropdown_status/tambah'); ?>"
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li>
                                                                <a data-id_status_kk="<?= $x['id_status_kk']; ?>"
                                                                    data-toggle="modal"
                                                                    data-target="#modal-edit<?= $x['id_status_kk']; ?>"
                                                                    class="btn btn-social btn-flat btn-block btn-sm"><i
                                                                        class="fa fa-upload"></i> Edit Bantuan</a>
                                                            </li>
                                                            <li>
                                                                <a href="<?= base_url('admin/Dropdown_status/hapus/' . $x['id_status_kk']); ?>"
                                                                    class="btn btn-social btn-flat btn-block btn-sm"><i
        ...
        <!-- /.row -->
        <?php $no = 0;
        foreach ($status_kk as $z) :
            $no++; ?>
        <div class="modal fade" id="modal-edit<?= $z['id_status_kk']; ?>">
            <div class="modal-dialog">
                <form name="myform" onsubmit="return val()" enctype="multipart/form-data" role="form"
                    action="<?= base_url('admin/Dropdown_status/ubah'); ?>" method="post">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">×</span></button>
                            <h4 class="modal-title">Tambah status_kk</h4>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <input type="hidden" value="<?= $z['id_status_kk']; ?>" name="id_status_kk" id=""
                                    class="form-control input-sm">
                                <div class="col-xs-12">
                                    <label class="">Nama status_kk</label>
                                    <input type="text" value="<?= $z['status_kk']; ?>" name="status_kk" id=""
                                        class="form-control input-sm">
                                </div>
                                <br>
                            </div>
