...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2022 at 05:28 PM
...
INSERT INTO `pengajuan` (`id_pengajuan`, `nama`, `tanggal`, `tempat`, `npwp`, `jenis_kelamin`, `jurusan`, `fakultas`, `universitas`, `nama_usaha`, `jenis_usaha`, `id_penduduk`, `status`, `opsi`, `timestamp`) VALUES
(20, '', '1970-01-01 00:00:00', '', '', '', '', '', '', '', '', 15, 'Diterima', 'SP Tanah', '2021-12-29 04:02:02'),
(21, '', '1970-01-01 00:00:00', '', '', '', '', '', '', '', '', 15, 'Diterima', 'Keterangan Domisili', '2022-01-05 02:20:16'),
(22, '', '1970-01-01 00:00:00', '', '', '', '', '', '', '', '', 15, 'Diterima', 'Keterangan Domisili', '2022-01-05 02:20:15'),
(23, '', '1970-01-01 01:00:00', '', '', '', '', '', '', '', '', 15, 'Diterima', 'Keterangan Domisili', '2022-01-05 02:20:13'),
(24, '', '1970-01-01 00:00:00', '', '', '', '', '', '', '', '', 15, 'Diterima', 'Keterangan Domisili', '2022-01-05 02:20:12'),
(25, '', '1970-01-01 00:00:00', '', '', '', '', '', '', '', '', 15, 'Proses', 'SP Tanah', '2022-01-16 16:03:05');
...
(100, '::1', '2021-12-29', 'Windows 10', 'Chrome', '1640745091'),
(101, '::1', '2021-12-29', '', '', '1640745142'),
(102, '::1', '2021-12-29', 'Windows 10', 'Chrome', '1640750767'),
(103, '::1', '2021-12-29', 'Windows 10', 'Chrome', '1640790230'),
(104, '::1', '2021-12-29', 'Windows 10', 'Chrome', '1640790238'),
(105, '::1', '2021-12-30', 'Windows 10', 'Chrome', '1640858938'),
(106, '::1', '2022-01-03', 'Windows 10', 'Chrome', '1641217545'),
(107, '::1', '2022-01-05', 'Windows 10', 'Chrome', '1641349866'),
(108, '::1', '2022-01-05', 'Windows 10', 'Chrome', '1641350078'),
(109, '::1', '2022-01-05', 'Windows 10', 'Chrome', '1641350679'),
(110, '::1', '2022-01-05', 'Windows 10', 'Chrome', '1641350682'),
(111, '::1', '2022-01-05', '', '', '1641351037'),
(112, '::1', '2022-01-05', '', '', '1641351050'),
(113, '::1', '2022-01-16', 'Windows 10', 'Chrome', '1642349063'),
(114, '::1', '2022-01-16', 'Windows 10', 'Chrome', '1642349092');
...
--
ALTER TABLE `penduduk_penolong_kelahiran`
  MODIFY `id_penolong_kelahiran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `penduduk_sakit`
--
ALTER TABLE `penduduk_sakit`
  MODIFY `id_sakit` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `penduduk_status_kk`
  MODIFY `id_status_kk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `penduduk_wn`
  MODIFY `id_status_wn` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `pengunjung`
  MODIFY `id_pengunjung` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;
